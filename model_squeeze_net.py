...
from source.squeezenet import SqueezeNet
...
# left off
baseModel = SqueezeNet(weights="imagenet", include_top=False,input_tensor=Input(shape=(224, 224, 3)))
...
model.save("mask_squeeze_net.model", save_format="h5")
